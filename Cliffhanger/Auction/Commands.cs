...
namespace Arya.Auction
{
	...
	public class AuctionCommands
	{
		...
		{
			Server.Commands.Register( "InitAuction", AccessLevel.Administrator, new CommandEventHandler( OnInitAuction ) );
			Server.Commands.Register( "MyAuction", AccessLevel.Player, new CommandEventHandler( OnMyAuction ) );
			Server.Commands.Register( "Auction", AccessLevel.GameMaster, new CommandEventHandler( OnAuction ) );
			Server.Commands.Register( "AuctionAdmin", AccessLevel.Administrator, new CommandEventHandler( OnAuctionAdmin ) );
		}
