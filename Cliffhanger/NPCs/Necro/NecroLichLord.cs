...
namespace Server.Mobiles
{
	...
	public class NecroLichLord : BaseCreature
	{
		[Constructable]
		public NecroLichLord() : base( AIType.AI_Necro, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a lich lord";
			Body = 79;
			BaseSoundID = 412;
		...
		public NecroLichLord( Serial serial ) : base( serial )
		{
		}
